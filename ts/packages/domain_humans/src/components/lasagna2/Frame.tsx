'use client'
import Painting from '@/components/lasagna2/Painting';
import { GraphElementNameType } from '@/components/lasagna2/classes';
import { path } from '@/components/lasagna2/specs';
import { path as pathNor } from '@/components/lasagna2/specsNor';
...
export default function Frame({ counter, setCounter, pathDescription, setPathDescription, isNor }: FrameProps) {
  ...
  return (
    <div className='bg-transparent w-full h-full p-16'>
