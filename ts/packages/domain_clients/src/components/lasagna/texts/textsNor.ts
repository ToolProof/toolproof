...
export const nodeDescriptions: Record<NodeNameType, string> = {
    ...
    Storage: 'Storage er en filmappe som deles mellom mennesker, verktøy og AI-en. Det er her ankre, mål, kandidater mv. lagres og hentes.',
    ...
    PrivateInternal: 'Private registrerer AI-ens interne tilstand og fungerer som en detaljert logg over hvert steg den tar, slik at den kan reflektere over sin egen atferd.',
    Standin: '',
};

export const resourceDescriptions: Record<string, string> = {
    'anchor.pdb': 'En anker fungerer som et utgangspunkt for legemiddelutviklingsprosessen. Et anker er vanligvis et eksisterende, men suboptimalt legemiddel (også kjent som et ligand) for den aktuelle sykdommen. Ankrene er representert som .pdb (Protein Storage Bank)-filer eller SMILES-strenger, begge brukt til å beskrive molekylstrukturer. Ankre som vil bli forsøkt med tanke på Lewy Body Demens er tyrosinhydroksylasehemmere som Imatinib og Nilotinib. Sistnevnte har gitt lovende testresultater mot denne sykdommen, men virkestoffet trenger i for liten grad inn i hjernen. Kanskje er det en forandring i designet på dette legemiddelet som skal til? (google "Georgetown University + Lewy Body + Nilotinib" for mer informasjon).',
