...
export class NodeBeta extends NodeBase<{ inputKeys: string[], outputKey: string, intraMorphism: string, outputDir: string, interMorphism: string, writeToShared: boolean }> {
    ...
    constructor(spec: { inputKeys: string[], outputKey: string, intraMorphism: string, outputDir: string, interMorphism: string, writeToShared: boolean; }) {
        super();
        this.spec = spec;
    }
