...
export default async function fooHandler(req, res) {
    try {
...
export async function fooHelper(isWindows) {
    try {
        ...
        fs.writeFileSync(filePath, JSON.stringify(result.messages[0].content, null, 2) +
            '\n\n\n' +
